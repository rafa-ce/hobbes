...
public class LexicoTest {
	...
	public void identificaUmaLinha() throws Throwable {
		...
		assertToken("while", 6, "palavra", lexico.getNextToken(entrada));
		assertToken("i", 8, "palavra", lexico.getNextToken(entrada));
		assertToken("<", 6, "simbolo", lexico.getNextToken(entrada));
		assertToken("100", 6, "numero", lexico.getNextToken(entrada));
		assertToken("do", 6, "palavra", lexico.getNextToken(entrada));
		assertToken("i", 6, "palavra", lexico.getNextToken(entrada));
		assertToken("=", 6, "simbolo", lexico.getNextToken(entrada));
		assertToken("j", 6, "palavra", lexico.getNextToken(entrada));
		assertToken("+", 6, "simbolo", lexico.getNextToken(entrada));
		assertToken("i", 6, "palavra", lexico.getNextToken(entrada));
	}
	...
	public void identificaDuasLinhas() throws Throwable {
		...
		assertToken("while", 6, "palavra", lexico.getNextToken(entrada1));
		assertToken("i", 8, "palavra", lexico.getNextToken(entrada1));
		assertToken("<", 6, "simbolo", lexico.getNextToken(entrada1));
		assertToken("100", 6, "numero", lexico.getNextToken(entrada1));
		assertToken("do", 6, "palavra", lexico.getNextToken(entrada1));
		assertToken("i", 6, "palavra", lexico.getNextToken(entrada2));
		assertToken("=", 6, "simbolo", lexico.getNextToken(entrada2));
		assertToken("j", 6, "palavra", lexico.getNextToken(entrada2));
		assertToken("+", 6, "simbolo", lexico.getNextToken(entrada2));
		assertToken("i", 6, "palavra", lexico.getNextToken(entrada2));
